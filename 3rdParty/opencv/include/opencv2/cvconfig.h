...
#define CUDA_ARCH_BIN " 50 52 53 60 61 62 70 75 80 86 87 89"

/* NVIDIA GPU features are used */
#define CUDA_ARCH_FEATURES " 50 52 53 60 61 62 70 75 80 86 87 89 35 75 90"

/* Compile for 'virtual' NVIDIA PTX architectures */
#define CUDA_ARCH_PTX " 35 75 90"
